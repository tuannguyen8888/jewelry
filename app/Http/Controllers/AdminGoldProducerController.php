<?php namespace App\Http\Controllers;
	...
	class AdminGoldProducerController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->table = "gold_producer";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Mã NSX","name"=>"code"];
			$this->col[] = ["label"=>"Tên NSX","name"=>"name"];
			$this->col[] = ["label"=>"Địa chỉ","name"=>"address"];
			$this->col[] = ["label"=>"Người liên hệ","name"=>"contact"];
			$this->col[] = ["label"=>"Số ĐT","name"=>"phone"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Mã NSX','name'=>'code','type'=>'text','validation'=>'required|min:1|max:10','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Tên NSX','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:200','width'=>'col-sm-10','placeholder'=>'Nhập tên nhà sản xuất'];
			$this->form[] = ['label'=>'Địa chỉ','name'=>'address','type'=>'text','validation'=>'max:400','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Người liên hệ','name'=>'contact','type'=>'text','validation'=>'max:100','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Số ĐT','name'=>'phone','type'=>'text','validation'=>'max:50','width'=>'col-sm-4'];
