...
<html>
  <head>
    ...
    <link rel='stylesheet' href='{{asset("css/site.customize.css")}}'/>
  </head>
      ...
      <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
          ...
          <div class="form-group has-feedback" style="height: 50px;">
            ...
            <input autocomplete='off' type="text" class="form-control" name='email' id="email" required placeholder="Email"/>
