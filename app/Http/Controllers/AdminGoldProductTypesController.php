<?php namespace App\Http\Controllers;
	...
	class AdminGoldProductTypesController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Tuổi vàng","name"=>"age","callback_php"=>'number_format($row->age, 2)'];
			...
			$this->form[] = ['label'=>'Tuổi vàng','name'=>'age','type'=>'text','validation'=>'required|numeric|min:0','width'=>'col-sm-4'];
	    ...
	    */
		...
		public function getListAll(){
            ...
            $para = Request::all();
            $list = DB::table('gold_product_types')->whereRaw('deleted_at is null')->get();
            return ['list'=>$list];
		}
