<?php namespace App\Http\Controllers;
	...
	class AdminGoldBrandsController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Mã số','name'=>'code','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-2'];
			$this->form[] = ['label'=>'Tên','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Địa chỉ','name'=>'address','type'=>'text','validation'=>'required|string|min:1|max:45','width'=>'col-sm-10'];
