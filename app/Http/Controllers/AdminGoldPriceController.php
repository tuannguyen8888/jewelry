<?php namespace App\Http\Controllers;
	...
	class AdminGoldPriceController extends CBExtendController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Giá bán ra","name"=>"sales_price","callback_php"=>'number_format($row->sales_price)'];
			$this->col[] = ["label"=>"Giá mua vào","name"=>"purchase_price","callback_php"=>'number_format($row->purchase_price)'];
			...
			$this->form[] = ['label'=>'Giá bán ra','name'=>'sales_price','type'=>'money','validation'=>'required|min:0','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Giá mua vào','name'=>'purchase_price','type'=>'money','validation'=>'required|min:0','width'=>'col-sm-4'];
