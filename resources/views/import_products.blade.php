                        ...
                        $(function(){
                            ...
                            {{--$('#review-data').dataTable({--}}
                                ...
                                {{--columns: [--}}
                                    ...
                                    {{--{ "data": "kl_tong", "orderable": false },--}}
                                    {{--{ "data": "kl_da", "orderable": false },--}}
                                    {{--{ "data": "kl_vang", "orderable": false },--}}
                                    {{--{ "data": "cong_ban", "orderable": false },--}}
                                    {{--{ "data": "cong_vip", "orderable": false },--}}
                                    {{--{ "data": "cong_von", "orderable": false },--}}
                                    {{--{ "data": "hlv", "orderable": false },--}}
                                    {{--{ "data": "loai_hang", "orderable": false },--}}
                                    {{--{ "data": "nhom_hang", "orderable": false },--}}
                                    {{--{ "data": "nha_san_xuat", "orderable": false }--}}
                                {{--],--}}
