	...
	<div>
		<div class='panel panel-default'>
			<div class='panel-heading'>
				<strong><i class="fa fa-dollar"></i> Báo cáo cầm vàng</strong>
			</div>
				...
				<form  id="form">
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-sm-1">
								<a id="print_report" style="cursor: pointer;" onclick="printReport(false)" class="btn btn-primary"><i class="fa fa-print"></i> In báo cáo</a>
							</div>
							{{--<label class="control-label col-sm-1"></label>--}}
							{{--<div class="col-sm-1">--}}
	...
	<script type="application/javascript">
        ...
        function printReport(isExport) {
            if(!$('#from_date').val()){
				...
				{{--if(isExport){--}}
					{{--popupWindow("{{action('AdminGoldPaymentsController@getPrintCostXlsx')}}/" + from_date + "@" + to_date + "@" + brand_id,"Export");--}}
				{{--}else{--}}
					{{--popupWindow("{{action('AdminGoldPaymentsController@getPrintCost')}}/" + from_date + "@" + to_date + "@"  + brand_id,"Print");--}}
				{{--}--}}
                popupWindow("{{action('AdminGoldPawnOrdersController@getPrintPawnReport')}}/" + from_date + "@" + to_date + "@" + brand_id,"Print");
            }
        }
	</script>
@endpush