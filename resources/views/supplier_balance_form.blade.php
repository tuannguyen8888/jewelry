	...
	<div>
		<div class='panel panel-default'>
			<div class='panel-heading'>
				<strong><i class="fa fa-bar-chart-o"></i>Công Nợ Nhà Cung Cấp</strong>
			</div>
...
// 				}
				...
				// $.ajax({
                // method: "GET",
                // url: '{{Route("AdminGoldSuppliersControllerGetBalanceDetail")}}/' + from_date + '/' + to_date,
                // data: {
                //     _token: '{{ csrf_token() }}'
                // },
                // dataType: "json",
				...
				////Use jasper
				popupWindow("{{action('AdminGoldSuppliersController@getPrintBalance')}}/" + from_date + "/" + to_date,"print");
            }
        }
