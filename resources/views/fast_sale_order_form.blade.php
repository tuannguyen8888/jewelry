...
@push('bottom')
	...
	<script type="application/javascript">
        ...
        function showModalcustomer_id() {
            var url_customer_id = "{{action('AdminGoldSaleOrdersController@getModalData')}}/gold_sale_orders/modal-data?table=gold_customers&columns=id,code,name,address,phone&name_column=customer_id&where=deleted_at+is+null+and+saler_id={{CRUDBooster::myId()}}&select_to=code:code&columns_name_alias=Mã khách hàng,Tên khách hàng,Địa chỉ,Số điện thoại";
